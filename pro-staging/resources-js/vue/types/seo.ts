...
/**
 * Events emitted by SEO components
 */
export interface SEOFormEmits {
  (event: 'saved', data: SEOData): void;
  (event: 'error', error: Error): void;
  (event: 'analyzed', report: AnalysisReport): void;
}

export interface KeywordManagerEmits {
  (event: 'update:modelValue', keywords: Keyword[]): void;
}
