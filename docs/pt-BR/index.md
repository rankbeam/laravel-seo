---
description: "Documentação do Rankbeam para Laravel em português do Brasil: instalação, metadados, sitemaps e Filament."
---

# Rankbeam para Laravel

O núcleo gratuito gerencia os metadados da sua aplicação. Comece pelo guia de início rápido e adicione as funções de que precisar.

- [Instalação](/pt-BR/guide/installation)
- [Início rápido](/pt-BR/guide/quickstart)
...
[Toda a documentação em inglês](/) · [Instalar o Pro (EN)](/pt-BR/pro/installation)
